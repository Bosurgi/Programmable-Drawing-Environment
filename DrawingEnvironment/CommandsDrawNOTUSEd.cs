...
namespace DrawingEnvironment
{
    ...
    /// </summary>
    public class CommandsDrawNOTUSEd : Command
    {
        // Attributes
        string name;
        int[] parameters;
        ...
        // Constructor
        public CommandsDrawNOTUSEd(string name, int[] parameters, Graphics g) : base(name, parameters)
        {
            name = this.name;
